...
import { Calculator as CalcIcon, Store, Droplet, Leaf } from 'lucide-react';
...
export default function Calculator() {
  ...
  return (
    <section id="calculator" className="bg-brand-sand py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="bg-white rounded-[2rem] p-8 shadow-2xl shadow-brand-ocean/5 border border-brand-teal/20 relative overflow-hidden">
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="p-3 bg-brand-teal/10 rounded-full border border-brand-teal/20">
                  <CalcIcon className="text-brand-teal h-6 w-6" />
                </div>
              ...
              <div className="mb-8">
                <label className="flex justify-between text-sm font-semibold text-brand-navy mb-4">
                  ...
                  <span className="text-xl text-brand-teal font-bold">{bottlesPerWeek}</span>
                </label>
                <input 
                  type="range" 
                  min="1" 
                  ...
                  className="w-full h-2 bg-brand-sand rounded-full appearance-none cursor-pointer border border-brand-teal/10 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-brand-teal"
                />
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="w-full h-1 bg-brand-sand rounded-full col-span-2 -mt-4 mb-2">
                  <div className="w-full h-full bg-brand-base/10 rounded-full"></div>
                </div>
                <div className="p-4 rounded-xl flex items-center justify-between col-span-2">
                  <div className="text-sm font-bold text-brand-ocean">Hydr8 Refill</div>
                  <div className="text-xl font-black text-brand-teal">R{hydr8Price * bottlesPerWeek}/wk</div>
                </div>
                <div className="w-full h-2 bg-brand-sand rounded-full col-span-2 -mt-4">
                  <div className="h-full bg-brand-teal rounded-full" style={{ width: `${(hydr8Price / retailPrice) * 100}%` }}></div>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-brand-ocean to-brand-navy p-10 shadow-xl text-white flex flex-col justify-between h-full border border-brand-ocean/50">
              <div className="absolute top-0 right-0 -mr-8 -mt-8 h-48 w-48 rounded-full bg-brand-teal/20 blur-[50px]"></div>
              <div>
                <h3 className="text-[10px] font-bold text-brand-cyan uppercase tracking-[0.2em] mb-4">Membership Savings</h3>
              ...
              <div className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl border border-white/10 mb-8">
                <div className="h-10 w-10 flex-shrink-0 rounded-full bg-brand-cyan/20 flex items-center justify-center">
                  <Leaf className="h-5 w-5 text-brand-cyan" />
                </div>
                <div>
              ...
              <button className="w-full rounded-xl bg-brand-teal px-6 py-4 text-center font-bold text-white transition-transform hover:scale-[1.02] active:scale-95 shadow-xl shadow-brand-teal/20">
